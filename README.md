💻 A modern, fully-functional operating system for FiveM servers. Beautiful UI with dark/light modes, 15+ built-in apps, VPN system, .onion sites, crypto wallet, and easy custom app development. Framework agnostic (QBCore/ESX). Open source and community-driven!
